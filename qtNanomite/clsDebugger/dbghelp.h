...
UnmapDebugInformation(
    _Out_ PIMAGE_DEBUG_INFORMATION DebugInfo
    );
...
EnumDirTree(
    ...
    _In_ PCSTR RootPath,
    _In_ PCSTR InputPathName,
    _Out_opt_ PSTR OutputPathBuffer,
...
EnumDirTreeW(
    ...
    _In_ PCWSTR RootPath,
    _In_ PCWSTR InputPathName,
    _Out_opt_ PWSTR OutputPathBuffer,
...
SymMatchFileName(
    _In_ PCSTR FileName,
    _In_ PCSTR Match,
    _Out_opt_ PSTR *FileNameStop,
    _Out_opt_ PSTR *MatchStop
    );
...
SymMatchFileNameW(
    _In_ PCWSTR FileName,
    _In_ PCWSTR Match,
    _Out_opt_ PWSTR *FileNameStop,
    _Out_opt_ PWSTR *MatchStop
    );
...
SymUnDName64(
    ...
    _Out_ PSTR UnDecName,   // Buffer to store undecorated name in
